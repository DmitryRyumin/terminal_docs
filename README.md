...
| `source название_каталога/bin/activate` | Активация виртуальной среды в указанном каталоге `Linux` |
| `название_каталога\Scripts\activate.bat` | Активация виртуальной среды в указанном каталоге `Windows` |
